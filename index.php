...
<html>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
		     ...
		     <h1>Powered by <a href="http://mobilegrows.com/" rel="external">MobileGrows </a>|<a href="http://www.southbeachtanning.biz/" rel="external"> DesktopSite</a></h1>
				...
				<fieldset class="ui-grid-a" data-theme="<?php echo $theme ?>">
					...
					<div class="ui-block-b" id="findUS">
						...
						<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
							<div 
								class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">ABOUT US</a>
							</div>
						</div>
						<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
							<div 
								class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">COUPONS</a>
							</div>
						</div>
						<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
							<div 
								class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">EQUIPMENT</a>
							</div>
						</div>
						<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
							<div 
								class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">SCIN CARE</a>
							</div>
						</div>
						<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					...
					<section id="navigation-menu">
						...
						<ul id="menu" class="menuhide">
							...
							<li><a href="#page2" data-transition="<?php echo $transitionefect ?>">COUPONS</a></li>
							<li><a href="#page2" data-transition="<?php echo $transitionefect ?>">EQUIPMENT</a></li>
							<li><a href="#page2" data-transition="<?php echo $transitionefect ?>">SCIN CARE</a></li>
